...
<template>
  <thead>
    <tr :class="{'loading': loading}">
      ...
      />
      <th
         v-for="(col, i) in columns" :key="i" v-show="!hasAdvancedFiltering || (hasAdvancedFiltering && col.isColVisible)"
      ...
      >
        ...
        >
          ...
          >
            ...
            <ul>
              <li
                v-for="(col, index) in tableColsOptions" :key="index" v-show="col.isTableOption"
