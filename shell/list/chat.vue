...
import RoomsList from '@shell/components/chat/RoomsList/RoomsList.vue'
import Room from '@shell/components/chat/Room/Room.vue'
import MediaPreview from '@shell/components/chat/MediaPreview/MediaPreview.vue'
export default {
  name:       'ListChats',
  components: {
    MessageInput,
    ...
    rooms: { type: [Array, String], default: () => [
        {
          "roomName": "123",
          "username": "abc",
          "id": "88bYp60jS861AHTzbC2j",
          "roomId": "88bYp60jS861AHTzbC2j",
        },
      ] },
